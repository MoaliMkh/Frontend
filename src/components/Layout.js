...
const Layout = () => {
  return (
    ...
    <div class="flex md:order-2">
        <Link to="/login">
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">ورود | ثبت‌نام</button>
        </Link>
...
<aside id="default-sidebar" class="fixed top-0 right-0 z-40 w-12 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
