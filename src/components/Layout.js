...
const Layout = () => {
  return (
    ...
    <a href="https://flowbite.com/" class="flex items-center">
      ...
      <Link to="/login" style={{ display: 'flex', flexWrap: 'wrap', flexDirection: 'row'}}> 
        <button type="button" class="">ورود | ثبت‌نام</button>
        <img src={login_img} alt="logo_img" style={{height: 20, marginLeft: 5}}></img>
        </Link>
      </div>
